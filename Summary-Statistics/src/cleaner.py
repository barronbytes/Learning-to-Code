class Cleaner():
    ...
    def brain(self) -> list[int] | None:
        '''
        For list input, filters string values, removes whitespace, and type casts values to integers.

        Returns:
            list[int] | None: For valid input, returns a list of integers; otherwise, returns None.
        '''
